...
def run_random_forest():
    ...
    results = []
    #I am searching the best number of estimators by testing some numbers
    for estimators in [25,50,100,200,300,500]:
        #I am defining the model as a Classifier with RandomForest, what uses the number of the estimator in the loop
        ...
        metrics = {
            #estimators are the number of DecisionTrees, which RandomForest are building in his function
